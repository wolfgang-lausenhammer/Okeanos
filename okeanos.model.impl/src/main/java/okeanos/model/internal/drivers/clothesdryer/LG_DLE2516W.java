package okeanos.model.internal.drivers.clothesdryer;
...
/**
 * Driver for the LG DLE2516W clothes dryer. Represents a regulable load, i.e.
 * the load can be influenced and scheduled.
 * 
 * @author Wolfgang Lausenhammer
 */
@Component("LG_DLE2516W")
public class LG_DLE2516W implements RegulableLoad {
	...
	/**
	 * Instantiates a new LG DLE2516W.
	 * 
	 * @param resource
	 *            the resource
	 * @param id
	...
	@Inject
	public LG_DLE2516W(
			@Value("${okeanos.model.internal.drivers.clothesdryer.LG_DLE2516W.loadProfilePath}") final Resource resource,
